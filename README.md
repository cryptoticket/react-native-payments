...
That's [react-native-payments]() repository fork with merged fixes:
...
# License
Licensed under the MIT License, Copyright © 2017, [Naoufal Kadhom](https://twitter.com/naoufal), 2019 [Crypto.Tickets](https://github.com/cryptoticket).

See [LICENSE](https://github.com//cryptoticket/react-native-payments/blob/master/LICENSE) for more information.
